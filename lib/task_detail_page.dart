          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  repeatingTasks = widget.tasks.where((task) {
                    return task.repeatingId == widget.task.repeatingId;
                  }).toList();
                  sortTasksByDueDate(repeatingTasks);
                  task = repeatingTasks.firstWhere((task) => !task.isComplete,
                      orElse: () => widget.task);
                  Navigator.of(context).pop(true);
                },
              ),
